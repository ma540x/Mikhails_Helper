...
Public Class Form1
    ...
    Private Sub Form1_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        '  MsgBox("The app will still be running in your System Tray area by the clock, right click on that icon to see the links!")
    ...
    Private Sub Button4_Click_2(sender As Object, e As EventArgs)
        TextBox1.Text = "DARP #"
        TextBox5.Text = "ITRACK #"
        System.Diagnostics.Process.Start("http://qetestautomation.com:5972/")
    End Sub
    ...
    Private Sub TimeLabel_Click_1(sender As Object, e As EventArgs) Handles TimeLabel.Click
    ...
    Private Sub Test3ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles Test3ToolStripMenuItem.Click
    ...
    Private Sub ManualFlashRequestToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ManualFlashRequestToolStripMenuItem.Click
    ...
    Private Sub DateLabel_Click_1(sender As Object, e As EventArgs) Handles DateLabel.Click
    ...
    Private Sub DayLabel_Click(sender As Object, e As EventArgs) Handles DayLabel.Click

    End Sub

    Private Sub ReadInventoryGuidelinesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReadInventoryGuidelinesToolStripMenuItem.Click
    ...
    Private Sub Label1_LostFocus(sender As Object, e As EventArgs) Handles Label1.LostFocus
    ...
    Private Sub ToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem3.Click, ToolStripMenuItem14.Click
    ...
    Private Sub WORKDAYToolStripMenuItem_Click(sender As Object, e As EventArgs)
    ...
    Private Sub ZipToolStripMenuItem_Click(sender As Object, e As EventArgs)
    ...
    Private Sub VersionNumberToolStripMenuItem_Click(sender As Object, e As EventArgs)
        ...
        ' Dim versionPublish As Version = ApplicationDeployment.CurrentDeployment.CurrentVersion

        '        MessageBox.Show(Version)
        'MessageBox.Show("The version number is {0}.{1}.{2}.{3}", version.Major, version.Minor, version.Build, version.Revision)
        '  Console.WriteLine("The version number is {0}.{1}.{2}.{3}", version.Major, version.Minor, version.Build, version.Revision)


        '   MsgBox(ApplicationDeployment.CurrentDeployment.CurrentVersion)
        '     MsgBox(ApplicationDeployment.CurrentDeployment.CurrentVersion)
        ' MsgBox(My.Application.Info.Version.ToString)
        'MsgBox(Deployment.Application.ApplicationDeployment.CurrentDeployment.CurrentVersion.ToString)
        '  ApplicationDeployment.CurrentDeployment.CurrentVersion And Reflection.Assembly.GetExecutingAssembly().GetName().Version
        ...
        '    lblVersion.Text = ApplicationDeployment.CurrentDeployment.CurrentVersion.Revision
        '   End If
        '  MsgBox(lblVersion)
    End Sub
    ...
    Private Sub CalculateExecutionStatusToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CalculateExecutionStatusToolStripMenuItem.Click
    ...
    Private Sub CheckOnAutomationStatusToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckOnAutomationStatusToolStripMenuItem.Click
        TextBox1.Text = "DARP #"
        TextBox5.Text = "ITRACK #"
        System.Diagnostics.Process.Start("http://qeta-jenkins.web.att.com/")
    End Sub

    Private Sub CheckAutomationDevices5979ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckAutomationDevices5979ToolStripMenuItem.Click
    ...
    Public Sub ITrack1ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ITrack1ToolStripMenuItem.Click
    ...
    Public Sub ITrack2ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ITrack2ToolStripMenuItem.Click
    ...
    Private Sub MenuStrip5_VisibleChanged(sender As Object, e As EventArgs) Handles MenuStrip5.VisibleChanged
    ...
    Private Sub DateLabel_MouseDown(sender As Object, e As MouseEventArgs) Handles DateLabel.MouseDown
    ...
    Private Sub AODACCESSTOZEPHYRITRACKToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles AODACCESSTOZEPHYRITRACKToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://aod.web.att.com/dashboard")
    End Sub

    Private Sub BUILDINGSECURITYCARDSACCESSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles BUILDINGSECURITYCARDSACCESSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/cre/buildingsecurity/default.aspx")
    End Sub

    Private Sub MYLOGINSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles MYLOGINSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://mylogins.cso.att.com/index.cfm")
    End Sub

    Private Sub SERVICEACTIVATIONORDERToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles SERVICEACTIVATIONORDERToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://saorder.sbc.com/Default.aspx")
    End Sub

    Private Sub VPNToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles VPNToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.e-access.att.com/iamportal-prod/rsauser/#/home")
    End Sub

    Private Sub AUTOMATIONHOMEPAGEToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles AUTOMATIONHOMEPAGEToolStripMenuItem.Click

        System.Diagnostics.Process.Start("http://qeta.web.att.com/")

    End Sub

    Private Sub AUTOMATIONINSTALLGUIDEToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles AUTOMATIONINSTALLGUIDEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/QETestAutomation/SitePages/Installation-Guides-And-other-Valuable-Links.aspx")
    ...
    Private Sub ATTPERKSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ATTPERKSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://attperks.benefithub.com/")
    End Sub

    Private Sub BENEFITSMEDICALVISIONDENTALToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles BENEFITSMEDICALVISIONDENTALToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://saml.e-access.att.com/isam/sps/ATTIDPEntity/saml20/logininitial?RequestBinding=HTTPPost&PartnerId=saml.alight.com&Target=https://sso.alight.com/portal%3FpageCd%3DL_YOUR_HEALTH_MATTERS")

    End Sub

    Private Sub BOLTToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles BOLTToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://bolt.web.att.com/#!/")

    End Sub

    Private Sub CAPSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles CAPSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://caps.web.att.com/esm80/#/exp/dashboard")

    End Sub

    Private Sub COUToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles COUToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://cou.web.att.com/app/#/COU/home")

    End Sub

    Private Sub ECORPToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ECORPToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://ecorplb.sbc.com/irj/portal")

    End Sub

    Private Sub FIDELITYToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles FIDELITYToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://fidelity.com")

    End Sub

    Private Sub HRONESTOPToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles HRONESTOPToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.e-access.att.com/hronestop")

    End Sub

    Private Sub INFORTIMEOFFToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles INFORTIMEOFFToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://mingle-portal.inforcloudsuite.com/ATT_PRD")

    End Sub

    Private Sub MOBILEIRONMYOWNToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles MOBILEIRONMYOWNToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://cou.web.att.com/app/#/BYOD/byodAction/home")

    End Sub

    Private Sub ONBOARDINGRESOURCESToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ONBOARDINGRESOURCESToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/Onboarding%20Resources%20(for%20Managers).aspx")

    End Sub

    Private Sub PLEToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles PLEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://PLE.WEB.ATT.COM/#/home")

    End Sub

    Private Sub PRISMToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles PRISMToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://prism.techdev.att.com/request-ui/#/request-search")
    ...
    Private Sub WEBSTRToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles WEBSTRToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://cmpmdt.web.att.com/cmpm/main.cfm")

    End Sub

    Private Sub WEBSTRManagerTimeApprovalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WEBSTRManagerTimeApprovalToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://cmpm.web.att.com/cmpm/#/supr/TimeReview")
    ...
    Private Sub EXITPROCESSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles EXITPROCESSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://hronestop.web.att.com/group/hr-onestop/company-exit-process")

    End Sub

    Private Sub QETIMETRACKERToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles QETIMETRACKERToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://workspace.web.att.com/sites/QualityEngineering1/QE_Time_Tracking/Lists/QE%20Hours/AllItems.aspx")

    End Sub

    Private Sub STRToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles STRToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.quickbase.com/db/btin2gcna")

    End Sub

    Private Sub WORKHOURSPERMONTHToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WORKHOURSPERMONTHToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.miraclesalad.com/webtools/work_hours_per_month.php")
    End Sub

    Private Sub ATTABBREVIATIONSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ATTABBREVIATIONSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://glossary.web.att.com/home/show#/home")

    End Sub

    Private Sub ATTINSIDERToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ATTINSIDERToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://insider.att.com")

    End Sub

    Private Sub ESIMWAITINGCONFIGURATIONToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ESIMWAITINGCONFIGURATIONToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/eSIM_Waiting_Config.aspx")

    End Sub

    Private Sub MOOSEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MOOSEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://moose.web.att.com")

    End Sub

    Private Sub QECMACHOMEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QECMACHOMEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC")

    End Sub

    Private Sub QEINVENTORYGUIDELINESToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles QEINVENTORYGUIDELINESToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/QE_Inventory_Guidelines.aspx")

    End Sub

    Private Sub TESTERONBOARDINGToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles TESTERONBOARDINGToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/Onboarding.aspx")

    End Sub

    Private Sub WEBPHONEToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles WEBPHONEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://webphone.att.com/")

    End Sub

    Private Sub ADMINRIGHTSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ADMINRIGHTSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://intranet.att.com/elrws/index.php")

    End Sub

    Private Sub IQBARToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles IQBARToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://iqbar.web.att.com/")

    End Sub

    Private Sub LEASEROLLToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles LEASEROLLToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://desktop.it.att.com/Steps.aspx")

    End Sub

    Private Sub RETURNLAPTOPSLABELToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles RETURNLAPTOPSLABELToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://askget.web.att.com/depot/depot-logistics-return-device")

    End Sub

    Private Sub FIREWALLEXCEPTIONSEFORCToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles FIREWALLEXCEPTIONSEFORCToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.e-access.att.com/eforc/requestcenter/index.php")

    End Sub

    Private Sub HELPDESKToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles HELPDESKToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://servicedesk.it.att.com/toolkit/cdt")

    End Sub

    Private Sub KICCAREATTPrePaidToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles KICCAREATTPrePaidToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://kiccare.tdc.cingular.net/webcc/Access.html")

    End Sub

    Private Sub KOUCricketToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles KOUCricketToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.e-access.att.com/cou/#/KOU/ack")

    End Sub

    Private Sub LABTICKETINGMOBILITYLABSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles LABTICKETINGMOBILITYLABSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://labticketing.web.att.com/am/")

    End Sub

    Private Sub LABTICKETSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles LABTICKETSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://support.labops.att.com/plugins/servlet/desk/portal/2")

    End Sub

    Private Sub MAGNUMTCETToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles MAGNUMTCETToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://intranet.att.com/project/magnum/")

    End Sub

    Private Sub MEETINGROOMSRESERVATIONSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles MEETINGROOMSRESERVATIONSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.e-access.att.com/ywr/cart")

    End Sub

    Private Sub TELEGENCEToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles TELEGENCEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://atthva.workspaceair.com/catalog-portal/ui#/app-favorite")

    End Sub

    Private Sub WORKPLACESUPPORTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WORKPLACESUPPORTToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/etech/Workplace2020/Pages/Support.aspx")

    End Sub

    Private Sub ITRACKATTToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ITRACKATTToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://itrack.web.att.com/browse")

    End Sub

    Private Sub ITRACKDARPToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ITRACKDARPToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://darp-jira.att.com/projects/DARP/issues")

    End Sub

    Private Sub ZEPHYRToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ZEPHYRToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.yourzephyr.com/flex/html5/release/5391")

    End Sub

    Private Sub ZIPToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ZIPToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.7-zip.org/download.html")
    End Sub

    Private Sub IMAZINGToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles IMAZINGToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://imazing.com/")
    End Sub

    Private Sub VYSORToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles VYSORToolStripMenuItem.Click

        System.Diagnostics.Process.Start("https://www.vysor.io/")
    End Sub

    Private Sub WINRARToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles WINRARToolStripMenuItem.Click

        System.Diagnostics.Process.Start("https://www.win-rar.com/download.html?&L=0")
    End Sub

    Private Sub TORCHToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TORCHToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://torch.web.att.com/ui/")
    End Sub

    Private Sub CheckOnProdAutomationDevicesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckOnProdAutomationDevicesToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://qeta-ws.web.att.com/CiServer1ScannedDevices")
    End Sub

    Private Sub CheckOnAutomationStatusDevelopmentJenkinsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckOnAutomationStatusDevelopmentJenkinsToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://qeta-jenkins.web.att.com/view/%20%20%20Test%20Script%20Development%20Farm/")
    End Sub

    Private Sub CheckOnAutomationDeviceFarmsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckOnAutomationDeviceFarmsToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://qeta-ws.web.att.com/")
    End Sub

    Private Sub QUICKBASEREQUESTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QUICKBASEREQUESTToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://directv-9861.quickbase.com/db/bqemycpp4")
    End Sub

    Private Sub CATOWEBSITEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CATOWEBSITEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://accessibility.web.att.com/")
    End Sub


    Private Sub RSAToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RSAToolStripMenuItem.Click
        System.Diagnostics.Process.Start("shell:appsFolder\RSASecurityLLC.RSASecurIDAuthenticate_1ze70x1yhyay8!App")
    End Sub

    Private Sub APPIUMINSPECTORToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles APPIUMINSPECTORToolStripMenuItem.Click
        Try
    ...
    Private Sub APPIUMSERVERToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles APPIUMSERVERToolStripMenuItem.Click
    ...
    Private Sub GITHUBREPOANDROMEDAToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GITHUBREPOANDROMEDAToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://github.com/dashboard")
    End Sub

    Private Sub STARTINTELLIJIDEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles STARTINTELLIJIDEToolStripMenuItem.Click
    ...
    Private Sub AUTOMATIONSHAREPOINTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AUTOMATIONSHAREPOINTToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/QETestAutomation")
    End Sub

    Private Sub AUTOMATIONCERTIFICATIONDEVICESToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AUTOMATIONCERTIFICATIONDEVICESToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://qeta-ws.web.att.com/CiServer1ScannedDevices")
    End Sub

    Private Sub CHECKAUTOMATIONDEVICES5979ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles CHECKAUTOMATIONDEVICES5979ToolStripMenuItem1.Click
        System.Diagnostics.Process.Start("http://qeta-ws.web.att.com/DevServerScannedDevices")
    End Sub

    Private Sub PASSWORDRESETSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PASSWORDRESETSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://support.web.att.com/product/31")
    End Sub

    Private Sub SELFSERVICEPORTALToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SELFSERVICEPORTALToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://support.web.att.com/")
    End Sub

    Private Sub OFFICIALATTHOLIDAYSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles OFFICIALATTHOLIDAYSToolStripMenuItem.Click
    ...
    Private Sub USBEXCEPTIONToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles USBEXCEPTIONToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/Shared%20Documents/Forms/AllItems.aspx?id=%2Fsites%2FCMAC%2FShared%20Documents%2FGeneral%2FGuides%2FUSB%20access%20request%20%2D%20ServiceNow%20guide%2Epdf&parent=%2Fsites%2FCMAC%2FShared%20Documents%2FGeneral%2FGuides")
    End Sub

    Private Sub DISKSHAREMANAGEMENTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DISKSHAREMANAGEMENTToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://saresource.it.att.com/Default.aspx")
    End Sub

    Private Sub ReassignADeviceToAnotherTesterToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReassignADeviceToAnotherTesterToolStripMenuItem.Click
    ...
    Private Sub SendEmailToInventoryToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SendEmailToInventoryToolStripMenuItem.Click
        Process.Start(String.Format("mailto:g18290@att.com?subject=%20&body=Hello,%0d%0a%0d%0a%0aThanks!"))

    End Sub

    Private Sub FIELDGLASSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles FIELDGLASSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://saml.e-access.att.com/isam/sps/ATTIDP/saml20/logininitial?RequestBinding=HTTPPost&PartnerId=https://www.fieldglass.com")
    End Sub


    Private Sub DHCPToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DHCPToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://eiss-dhcp.it.att.com/dhcpleaserequest.html")
    End Sub

    Private Sub ATTFOODTRUCKSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ATTFOODTRUCKSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.bestfoodtrucks.com/lots/at-t-bothell")
    End Sub

    Private Sub AssetsCheckedOutToMeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AssetsCheckedOutToMeToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://qe-inventory.web.att.com/account/view-assets#asset")
    End Sub

    Private Sub CheckOutNewAssetsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckOutNewAssetsToolStripMenuItem.Click
    ...
    Private Sub SEARCHFORASPECIFICMODELNUMBERToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SEARCHFORASPECIFICMODELNUMBERToolStripMenuItem.Click
        Form6.Show()
    End Sub

    Private Sub REQUESTADEVICEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles REQUESTADEVICEToolStripMenuItem.Click
        Process.Start(String.Format("mailto:g18290@att.com?subject=Device%20Request&body=Hello,%0d%0aI'd%20like%20to%20request%20the%20following%20device(s)%20from%20Inventory:%0d%0a%0d%0aDevice:%0d%0aFirmware%20Version:%0d%0a%0d%0aThanks!"))
    End Sub

    Private Sub REASSIGNDEVICEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles REASSIGNDEVICEToolStripMenuItem.Click
        Process.Start(String.Format("mailto:g18290@att.com?subject=Please%20Reassign%20my%20Device%20to%20a%20different%20Tester&body=Hello,%0d%0aI'd%20like%20to%20request%20a%20that%20my%20below%20device(s)%20be%20reassigned%20to%20a%20different%20tester.%20I'm%20cc'ing%20them%20here%20for%20their%20awareness.%0d%0a%0d%0aDevice:%0d%0aTester:%20%0d%0a%0aThanks!"))
    End Sub

    Private Sub SENDEMAILTOQEINVENTORYToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SENDEMAILTOQEINVENTORYToolStripMenuItem.Click
        Process.Start(String.Format("mailto:g18290@att.com?subject=%20&body=Hello,%0d%0a%0d%0a%0aThanks!"))
    End Sub

    Private Sub FOTAREQUESTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles FOTAREQUESTToolStripMenuItem.Click
        Process.Start(String.Format("mailto:g18290@att.com?subject=FOTA%20Request&body=Hello,%0d%0aI'd%20like%20to%20request%20FOTA%20to%20be%20pushed%20to%20the%20following:%0d%0a%0d%0aDevice:%0d%0aFirmware%20Version:%0d%0aCTN:%0d%0a%0d%0aThanks!"))
    End Sub

    Private Sub MANUALFLASHREQUESTToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles MANUALFLASHREQUESTToolStripMenuItem1.Click
        Process.Start(String.Format("mailto:g18290@att.com?subject=Manual%20Flash%20Request&body=Hello,%0d%0aI'd%20like%20to%20request%20a%20manual%20flash%20with%20the%20following%20device(s)%20and%20FW:%0d%0a%0d%0aDevice:%0d%0aFirmware%20Version:%0d%0a%0aThanks!"))
    End Sub

    Private Sub CALCULATEMANUALEXECUTIONToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CALCULATEMANUALEXECUTIONToolStripMenuItem.Click
    ...
    Private Sub QEINVENTORYGUIDELINESToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles QEINVENTORYGUIDELINESToolStripMenuItem1.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/QE_Inventory_Guidelines.aspx")
    End Sub

    Private Sub ToolStripSeparator112_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ToolStripSeparator117_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ToolStripSeparator116_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ToolStripSeparator115_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub TEST3ToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles TEST3ToolStripMenuItem2.Click
        System.Diagnostics.Process.Start("http://qeta-jenkins.web.att.com/")
    End Sub

    Private Sub TEST4ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TEST4ToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://qeta-jenkins.web.att.com/view/%20%20%20Test%20Script%20Development%20Farm/")
    End Sub
    ...
    Private Sub SEEALLCRICKETASSETSININVENTORYToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SEEALLCRICKETASSETSININVENTORYToolStripMenuItem.Click
    ...
    Private Sub QEAssetManagerInfoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QEAssetManagerInfoToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/Asset-manager.aspx")
    End Sub

    Private Sub ReadAssetSiteInfoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReadAssetSiteInfoToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/Asset-manager.aspx")
    End Sub

    Private Sub SOFTWARECENTERToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SOFTWARECENTERToolStripMenuItem.Click
        Try
    ...
    Private Sub SSQUICKREFERENCEGUIDEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SSQUICKREFERENCEGUIDEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://hronestop.web.att.com/documents/33859/fe149c72-f006-8258-64c1-ed606c896540")
    End Sub

    Private Sub NSSQUICKREFERENCEGUIDEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles NSSQUICKREFERENCEGUIDEToolStripMenuItem.Click
    ...
    Private Sub ADMINRIGHTSTEMPToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ADMINRIGHTSTEMPToolStripMenuItem.Click
    ...
    Private Sub ABOUTMIKHAILSHELPERToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ABOUTMIKHAILSHELPERToolStripMenuItem.Click
        If My.Application.IsNetworkDeployed Then
            'MsgBox(My.Application.Deployment.CurrentVersion.Revision.ToString())
            '  MsgBox(My.Application.Deployment.CurrentVersion.Revision)
            ' MsgBox(My.Application.Deployment.CurrentVersion.ToString())
    ...
    Private Sub SHAREPOINTSITEToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SHAREPOINTSITEToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att.sharepoint.com/sites/CMAC/SitePages/Mikhail%27s_Helper_Tool.aspx")
    End Sub

    Private Sub PROVIDEFEEDBACKToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles PROVIDEFEEDBACKToolStripMenuItem1.Click
        Process.Start(String.Format("mailto:ma540x@att.com?subject=Feedback/Suggestions%20for%20Mikhails%20Helper%20Tool&body="))
    End Sub

    Private Sub SHARETHISAPPToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SHARETHISAPPToolStripMenuItem1.Click
        Process.Start(String.Format("mailto:?subject=Check%20out%20this%20app!&body=Hiya,%0d%0aCheck%20out%20this%20app:%20https://att.sharepoint.com/sites/CMAC/SitePages/Mikhail%27s_Helper_Tool.aspx%0d%0a%0d%0aThanks!"))


    End Sub

    Private Sub ATTSHAREPOINTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ATTSHAREPOINTToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://att-my.sharepoint.com/my")
    End Sub

    Private Sub ToolStripSeparator117_Click_1(sender As Object, e As EventArgs) Handles ToolStripSeparator117.Click
