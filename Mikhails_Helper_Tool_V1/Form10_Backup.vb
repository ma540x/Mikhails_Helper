...
Public Class Form1
    ...
    Private Sub SetITrackProjectToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SetITrackProjectToolStripMenuItem1.Click
        Form5.Show()
    End Sub
    ...
    Private Sub ShareThisAppToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ShareThisAppToolStripMenuItem.Click
        Me.TopMost = False
        ...
        If Outl IsNot Nothing Then
            ...
            ' omsg.To = "g18290@att.com"
            'omsg.bcc = "yusuf@gmail.com"
            omsg.subject = "Check out this app!"
            omsg.body = "Hiya," & vbNewLine & "Check out this app:  " & vbNewLine & "https://att.sharepoint.com/sites/CMAC/SitePages/Mikhail%27s_Helper_Tool.aspx" & vbNewLine & vbNewLine & "Thanks!"
    ...
    Private Sub ProvideFeedbackToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ProvideFeedbackToolStripMenuItem.Click
        Me.TopMost = False
        ...
        If Outl IsNot Nothing Then
            Dim omsg As Object
            omsg = Outl.CreateItem(0)
            omsg.To = "ma540x@att.com"
            'omsg.bcc = "yusuf@gmail.com"
            omsg.subject = "Feedback on Mikhails Helper Tool"
            ' omsg.body = "Hiya," & vbNewLine & "Check out this app:  " & vbNewLine & "https://att.sharepoint.com/sites/CMAC/SitePages/Mikhail%27s_Helper_Tool.aspx" & vbNewLine & vbNewLine & "Thanks!"-
            omsg.Display(True) 'will display message to user
        End If
    ...
    Private Sub Form1_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            NotifyIcon1.Visible = True
            Me.Hide()
            '  NotifyIcon1.BalloonTipText = "Helper App is still running.."
    ...
    Private Sub CHECKONAUTOMATIONSTATUSToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles CHECKONAUTOMATIONSTATUSToolStripMenuItem1.Click
        System.Diagnostics.Process.Start("http://qeta-jenkins.web.att.com/")
    End Sub
    ...
    Private Sub GITHUBREPOANDROMEDAToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GITHUBREPOANDROMEDAToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://github.com/UET-Automation/Andromeda")
    End Sub
    ...
    Private Sub FIELDGLASSToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles FIELDGLASSToolStripMenuItem.Click
        System.Diagnostics.Process.Start("https://www.fieldglass.net/desktop.do")
    End Sub
    ...
    Private Sub AssetsCheckedOutToMeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AssetsCheckedOutToMeToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://10.123.210.153:8000/account/view-assets#asset")
    End Sub
    ...
    Private Sub CheckOutNewAssetsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckOutNewAssetsToolStripMenuItem.Click
        System.Diagnostics.Process.Start("http://10.123.210.153:8000/hardware")
    End Sub
